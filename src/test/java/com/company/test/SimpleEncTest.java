...
public class SimpleEncTest {
    ...
    void sizesEq() throws IOException, ReadException, WriteException {
        ...
        simpleEncryptorLogic.simpleEncrypt(true, new ByteArrayInputStream("qwe".getBytes()), output, 3, new char[]{'a', 's', 'd'}, 3);
    ...
    void bufSizeNotMultipleOfInp() throws IOException, ReadException, WriteException {
        ...
        encryptorLogic.simpleEncrypt(true, new ByteArrayInputStream("qwe".getBytes()), output, 3, new char[]{'a', 's', 'd'}, 2);
    ...
    void bufSizeMultipleOfInp() throws IOException, ReadException, WriteException {
        ...
        encryptorLogic.simpleEncrypt(true, new ByteArrayInputStream("qweqwe".getBytes()), output, 6, new char[]{'a', 's', 'd', 'a', 's', 'd'}, 2);
        byte[] bytes = output.toByteArray();
    ...
    void bufSizeBiggerThanInp() throws IOException, ReadException, WriteException {
        ...
        encryptorLogic.simpleEncrypt(true, new ByteArrayInputStream("qwe".getBytes()), output, 3, new char[]{'a', 's', 'd'}, 4);
        byte[] bytes = output.toByteArray();
    ...
    void keyIsSmallerInp() throws IOException, ReadException, WriteException {
        ...
        encryptorLogic.simpleEncrypt(true, new ByteArrayInputStream("qwe".getBytes()), output, 3, new char[]{'a', 's'}, 3);
        byte[] bytes = output.toByteArray();
    ...
    void keyIsLongerInp() throws IOException, ReadException, WriteException {
        ...
        encryptorLogic.simpleEncrypt(true, new ByteArrayInputStream("qwe".getBytes()), output, 3, new char[]{'a', 's', 'd', 'f'}, 3);
        byte[] bytes = output.toByteArray();
